...
<html lang="zh-CN">
  ...
  <link rel="stylesheet" href="__STATIC__/index/css/mobi.min.css">
<link rel="stylesheet" href="__STATIC__/index/css/style.css">
<link rel="stylesheet" href="__STATIC__/index/css/theme.css">
...
<div class="theme-header-placeholder"></div>
    ...
    <div class="flex-center">
      <div class="container">
        <ul class="top-gap-big theme-ul-no-style">
  
    <li>
      <a href="/2017/03/12/test_coverage_for_github/" class="theme-header-link">
        <h3>GitHub 上的测试覆盖率</h3>
      </a>
      <div class="text-small text-muted">
  <time datetime="2017-03-12T16:27:05+08:00">
    2017-03-12
  </time>
  ...
  <span class="theme-comment-count-container theme-hide theme-comment-count-container-transparent">
    ...
    <a class="text-muted theme-text-no-decoration theme-comment-count" data-disqus-identifier="2017/03/12/test_coverage_for_github/" href="/2017/03/12/test_coverage_for_github/#disqus_thread"></a>
  </span>
</div>

      
        
          <p>介绍 GitHub 与 Travis CI 结合的文章已经很多了，本篇文章主要介绍一下测试覆盖率的概念以及如何将测试覆盖率的 badge 添加到 README.md 中。</p>
        
          <p><a class="text-muted" href="/2017/03/12/test_coverage_for_github/#more">
            继续阅读
          </a></p>
      
      <div class="top-gap theme-bfc"></div>
    </li>
  
    <li>
      <a href="/2017/02/13/about_me/" class="theme-header-link">
        <h3>三分钟创建一个简单精致的 About Me 页面</h3>
      </a>
      <div class="text-small text-muted">
  <time datetime="2017-02-13T20:03:15+08:00">
    2017-02-13
  </time>
  <span class="theme-separator">·</span>
  <i class="czs-user-l"></i>
  ...
  <span class="theme-comment-count-container theme-hide theme-comment-count-container-transparent">
    <span class="theme-separator">·</span>
    <i class="czs-comment-l"></i>
    <a class="text-muted theme-text-no-decoration theme-comment-count" data-disqus-identifier="2017/02/13/about_me/" href="/2017/02/13/about_me/#disqus_thread"></a>
  </span>
</div>
...
<p>通过 Fork 一个仓库，创建基于 GitHub Pages 的 About Me 页面。</p>
          ...
          <p><a class="text-muted" href="/2017/02/13/about_me/#more">
            继续阅读
          </a></p>
    ...
    <li>
      <a href="/2017/01/29/flico/" class="theme-header-link">
        <h3>晒键盘 - FILCO 87 双模忍者圣手二代 黑色青轴</h3>
      </a>
      <div class="text-small text-muted">
  <time datetime="2017-01-29T17:51:31+08:00">
    2017-01-29
  </time>
  <span class="theme-separator">·</span>
  <i class="czs-user-l"></i>
  ...
  <span class="theme-separator">·</span>
  <i class="czs-bookmark-l"></i>
  <a class="text-muted theme-text-no-decoration" href="/categories/Life/">Life</a>
  <span class="theme-comment-count-container theme-hide theme-comment-count-container-transparent">
    <span class="theme-separator">·</span>
    <i class="czs-comment-l"></i>
    <a class="text-muted theme-text-no-decoration theme-comment-count" data-disqus-identifier="2017/01/29/flico/" href="/2017/01/29/flico/#disqus_thread"></a>
  </span>
</div>

      
        
          <p><img alt="FLICO-05" src="/assets/flico/FLICO-05.jpeg" /></p>
        
          <p><a class="text-muted" href="/2017/01/29/flico/#more">
            继续阅读
          </a></p>
    ...
    <li>
      <a href="/2017/01/19/full_color_screen/" class="theme-header-link">
        <h3>随手撸了个测试屏幕坏点的网页</h3>
      </a>
      <div class="text-small text-muted">
  <time datetime="2017-01-19T00:22:34+08:00">
    2017-01-19
  </time>
  <span class="theme-separator">·</span>
  <i class="czs-user-l"></i>
  ...
  <span class="theme-comment-count-container theme-hide theme-comment-count-container-transparent">
    <span class="theme-separator">·</span>
    <i class="czs-comment-l"></i>
    <a class="text-muted theme-text-no-decoration theme-comment-count" data-disqus-identifier="2017/01/19/full_color_screen/" href="/2017/01/19/full_color_screen/#disqus_thread"></a>
  </span>
</div>
    ...
    <li>
      <a href="/2017/01/17/my_first_book/" class="theme-header-link">
        <h3>我写的第一本书《TypeScript 入门教程》</h3>
      </a>
      <div class="text-small text-muted">
  <time datetime="2017-01-17T17:55:08+08:00">
    2017-01-17
  </time>
  <span class="theme-separator">·</span>
  <i class="czs-user-l"></i>
  ...
  <span class="theme-comment-count-container theme-hide theme-comment-count-container-transparent">
    <span class="theme-separator">·</span>
    <i class="czs-comment-l"></i>
    <a class="text-muted theme-text-no-decoration theme-comment-count" data-disqus-identifier="2017/01/17/my_first_book/" href="/2017/01/17/my_first_book/#disqus_thread"></a>
  </span>
</div>
          ...
          <p><a class="text-muted" href="/2017/01/17/my_first_book/#more">
            继续阅读
          </a></p>
  ...
  <nav class="theme-pagination top-gap-big text-center">
    <a class="extend prev" rel="prev" href="/"><i class="czs-angle-left-l"></i></a><a class="page-number" href="/">1</a><span class="page-number current">2</span><a class="page-number" href="/page/3/">3</a><span class="space">&hellip;</span><a class="page-number" href="/page/11/">11</a><a class="extend next" rel="next" href="/page/3/"><i class="czs-angle-right-l"></i></a>
  </nav>
...
<aside class="theme-sidebar-wrapper">
  ...
  <div class="container">
    ...
    <script src="__STATIC__/index/js/theme.js"></script>
<!--     
  <script>
  ...
  <script id="dsq-count-scr" src="__STATIC__/index/js/count.js" async></script>
